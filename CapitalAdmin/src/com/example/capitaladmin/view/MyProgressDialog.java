...
//		customProgressDialog.setContentView(R.layout.fashiondiy_progress_dialog);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int dialogWidth = CapitalAdminApplication.getContext().screenSize.widthPixels / 3;
		int dialogHeight = CapitalAdminApplication.getContext().screenSize.widthPixels / 3;
